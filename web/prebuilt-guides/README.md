# Prebuilt scene guides

These files are release copies of finished HTML/SVG scenes used directly by Uizador.

- The editable source remains in [`norbymezz/norbertachatelli`](https://github.com/norbymezz/norbertachatelli).
- Uizador does not regenerate them and does not convert them to video.
